...
function delResponList(groupID, key, _db) {
    ...
    if (position !== null) {
        ...
        fs.writeFileSync('./src/list-message.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetDone = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        ...
        fs.writeFileSync('./src/set_done.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetProses = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/set_proses.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetClose = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/set_close.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetOpen = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/set_open.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetWelcome = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/set_welcome.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetLeft = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/set_left.json', JSON.stringify(_db, null, 3))
    }
}
...
const addSewaGroup = (gid, expired, _dir) => {
    ...
    _dir.push(obj)
    fs.writeFileSync('./src/sewa.json', JSON.stringify(_dir, null, 2))
}
...
function addPay(groupID, pay, caption, _db) {
    ...
    _db.push(obj_add)
    fs.writeFileSync('./src/pay.json', JSON.stringify(_db, null, 3))
}
